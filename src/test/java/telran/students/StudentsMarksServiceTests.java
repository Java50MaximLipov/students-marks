...
class StudentsMarksServiceTests {
	...
	void getStudentMarksAtDatesTest() {
		List<Mark> expected = List.of(new Mark(SUBJECT1, 70, DATE3), new Mark(SUBJECT4, 70, DATE4));
		assertIterableEquals(expected, studentsService.getStudentMarksAtDates(ID4, DATE3, DATE4));
